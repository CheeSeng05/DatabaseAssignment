...
ALTER TABLE competitor ADD CONSTRAINT chk_gender CHECK (comp_gender IN ('M', 'F', 'U'));

ALTER TABLE competitor ADD CONSTRAINT chk_unistatus CHECK (comp_unistatus IN ('Y', 'N'));

ALTER TABLE competitor ADD CONSTRAINT unique_phone UNIQUE (comp_phone);

ALTER TABLE competitor ADD CONSTRAINT unique_email UNIQUE (comp_email);
...
ALTER TABLE entry ADD CONSTRAINT entry_pk PRIMARY KEY ( entry_no, event_id );
...
ALTER TABLE team ADD CONSTRAINT unique_team_name_and_date UNIQUE (team_name, carn_date);
